...
let virtual-env = "D:\100DaysCodingChellenge(Python)\Day-19 (State Instance and Higher order Function\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\100DaysCodingChellenge(Python)\Day-19 (State Instance and Higher order Function\venv\Scripts\deactivate.nu"
